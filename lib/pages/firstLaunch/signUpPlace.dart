...
class SignUpPlaceScreen extends StatefulWidget {
  final int type;
  SignUpPlaceScreen({this.type});

  @override
  _SignUpPlaceScreen createState() => _SignUpPlaceScreen();
}

class _SignUpPlaceScreen extends State<SignUpPlaceScreen> {
  dynamic data;
...
//
                    ...
                    FormBuilderTextField(
                      ...
                      decoration: MyDecoration(readOnly: readOnly)
                          .getInputDecoration('رقم التواصل'),
                    ),
                    SizedBox(
                      height: 30,
                    ),
